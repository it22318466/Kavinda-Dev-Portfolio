...
import { Download, Code, Sparkles, Code2 } from "lucide-react";
import {
  SiReact,
  SiNextdotjs,
  SiTypescript,
  ...
  return (
    <section id="about" className="relative py-20 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(28rem,36rem)_1fr] gap-16 items-start mb-20">
          {/* Left Column - Content */}
          <div className="flex flex-col gap-10 items-start">
            <div className="flex flex-col gap-8 w-full">
              ...
              <FadeIn delay={200}>
                <div className="flex flex-col gap-4 w-full max-w-[38rem] text-left">
                  {PERSONAL_INFO.bio.map((paragraph, index) => (
                    <p
                      key={index}
                      className="text-base text-white/60 leading-7 tracking-wide break-words"
                    >
                      {paragraph}
                    </p>
                  ))}
